...
public class frmDatosFunciones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTituloClasifi.setText("IDPelicula");
        jPanel1.add(lblTituloClasifi, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 120, 90, 30));
        ...
        lblTituloGenero3.setText("IDSala");
        jPanel1.add(lblTituloGenero3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 60, 30));
        ...
        jPanel1.add(txtPeli, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 130, -1));
        jPanel1.add(txtSala, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 130, -1));
    ...
    private void btnGuardarDatosPeli1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarDatosPeli1ActionPerformed
        int idPelicula = Integer.parseInt(txtPeli.getText());
